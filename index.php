...
<body class="index-page">
    ...
    <div class="container-fluid container-xl position-relative d-flex align-items-center justify-content-between">
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          ...
          <li><a href="#gallery">ARTIKEL</a></li>
  ...
  <main class="main">
      ...
      <div class="container">
        <div class="row gy-4 justify-content-between">
          <div class="col-lg-4 order-lg-last hero-img" data-aos="zoom-out" data-aos-delay="100">
            <img src="assets/img/LOGO BARU 2023 HITAM apk.png" class="img-fluid animated" alt="">
          </div>
    ...
    <section id="pricing" class="pricing section">
      ...
      <div class="container section-title" data-aos="fade-up">
        <h2>LAYANAN</h2>
        <div><span>BROADBAND</span> <span class="description-title"></span></div>
      </div>
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4" data-aos="zoom-in" data-aos-delay="100">
            <div class="pricing-item">
              ...
              <ul>
                ...
                <li><i class="bi bi-check"></i> <span class="text-danger">Gratis &nbsp;</span><span> Biaya Instalasi</span></li>
                <li><i class="bi bi-check"></i> <span>Full Fiber Optic</span></li>
                <li><i class="bi bi-check"></i> <span>Kuota Unlimited</span></li>
                <li><i class="bi bi-check"></i> <span>Support 24 Jam</span></li>
                <li><i class="bi bi-check"></i> <span>CIR 1:1</span></li>
              </ul>
              <a href="https://wa.me/+6281346356155" target="_blank" class="cta-btni">Langganan</a>
            </div>
          </div>
          ...
          <div class="col-lg-4" data-aos="zoom-in" data-aos-delay="200">
            <div class="pricing-item featured">
              ...
              <a href="https://wa.me/+6281346356155" target="_blank" class="cta-btn">Langganan</a>
            </div>
          </div>
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        <div class="row align-items-xl-center gy-5">
          ...
          <div class="col-xl-5 content">
            <!-- <h3>About Us</h3> -->
            <h2>Melayani Dengan Sepenuh Hati Memberikan Pelayanan Koneksi Internet Terbaik Untuk Anda</h2>
            <p>PT. OVALL SOLUSINDO MANDIRI merupakan salah satu perusahaan di Kabupaten ​Bogor yang bergerak dibidang pelayanan jasa internet. Dengan berkembangnya ​teknologi saat ini, maka dibutuhkan pula internet yang memadai agar dapat ​mengimbangi perkembangan teknologi. Untuk itu PT Ovall Solusindo Mandiri hadir ​agar dapat membantu menunjang perkembangan teknologi saat ini. Perusahaan ​kami menawarkan berbagai jenis kolaborasi yang sesuai bidang keahlian kami ​kepada perusahaan-perusahaan lainnya, baik perusahaan pemerintahan ​maupun perusahaan non-pemerintah.</p>
            ...
            <div class="row gy-4 icon-boxes">
              ...
              <div class="col-md-6" data-aos="fade-up" data-aos-delay="200">
                <div class="icon-box">
                  ...
                  <h3>Visi</h3>
                  <p>Menjadi penyelenggara jasa layanan internet yang unggul berkualitas dan menciptakan nilai yang optimal bagi pelanggan</p>
                </div>
              </div> <!-- End Icon Box -->
  ...
  <footer id="footer" class="footer dark-background">
      ...
      <div class="row gy-4">
        <div class="col-lg-4 col-md-6 footer-about">
          ...
          <div class="footer-contact pt-3">
            <p>Perum. Alam Tirta Lestari</p>
            <p>Bogor, Jawa Barat</p>
            <p class="mt-3"><strong>Phone:</strong> <span>+6285158155520</span></p>
            <p><strong>Email:</strong> <span>office@osm.net.id</span></p>
          </div>
        ...
        <div class="col-lg-4 col-md-12 footer-newsletter">
          <h4>Konsultasi</h4>
          <p>Untuk informasi lebih lanjut mengenai layanan Kami, Anda dapat menghubungi kami melalui kontak WhatsApp berikut</p>
    ...
    <div class="container copyright text-center mt-4">
      <p>© <span>Copyright</span> <strong class="px-1 sitename">OSM</strong> <span>All Rights Reserved</span>
      </p>
      <div class="credits">
